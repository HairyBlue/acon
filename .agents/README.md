...
- **[skills/](skills/)**: Curated skills organized across 4 specialized domains:
  ...
  - **[`productivity/`](skills/productivity/README.md)** (12 skills): Master orchestrator, repository adoption (`adopt-acon`), 9-dimension intent extraction (`prompt-master`), machine grammars (`grammars-and-constrained-sampling`), anti-overengineering (`ponytail`), plan interrogation (`grill-me`), context compaction (`handoff`), RFC authoring, and progress reporting.
