...
2. **Dense Machine State:** Rather than a verbose multi-page summary, structure active state using the canonical [`.agents/reference/schemas/handoff-state.yaml`](../../../reference/schemas/handoff-state.yaml) schema:
   ```yaml
   session_id: "<id>"
