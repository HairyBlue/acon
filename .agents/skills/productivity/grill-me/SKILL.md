...
3. **Structured Grammar Envelope:** When producing structured interview state or programmatic rounds for interactive CLI wizards (`ask_question`), conform strictly to the `grill-interview.yaml` schema:
   ```yaml
   round: 1
