...
| **`teach`** | Multi-session interactive technical coaching with glossaries, learning records, and missions. | [`teach/SKILL.md`](teach/SKILL.md) |
...
| **`wait-what`** | Re-pitches complex or jargon-heavy explanations in plain English with missing context. | [`wait-what/SKILL.md`](wait-what/SKILL.md) |
